...
import censetagger.ui.vertexinfo.PopupInfoDialog;
import censetagger.ui.vertexinfo.VertexPopupMenuPlugin;
...
public class DocumentProfileVisualizer extends JDialog {
	...
	public void visualize(String name,
			DirectedSparseMultigraph<censetagger.profile.SentimentVertex, String> graph) {
		this.name = name;
		origGraph = makeCopy(graph);
