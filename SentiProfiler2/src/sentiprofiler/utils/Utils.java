 ...
 * updated by Calkin Suero Montero
 *
 */
public class Utils {
	...
	public static String getTwoDecimals(double d) {        
		...
		// these two lines added to work on linux
		Double twoD = Double.valueOf(df.format(d));
		String formatted = twoD.toString();
	 ...
	 */
	  ...
	  * @return
	  */
	 public static String chooseFile(Component parent, String dir, FileFilter filter) {
